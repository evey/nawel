...
emailSettings.SmtpUsername = Environment.GetEnvironmentVariable("SMTP_USERNAME") ?? emailSettings.SmtpUsername;
emailSettings.SmtpPassword = Environment.GetEnvironmentVariable("SMTP_PASSWORD") ?? emailSettings.SmtpPassword;
